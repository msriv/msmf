    ...
    <div className="timeline">
      <div className="timeline-container left">
        <ImageListItem
          ...
          vector={{
            src: "https://cdn.ms-mf.org/images/Incubation/write 1.png",
            alt: "Innovation",
          }}
        />
      </div>
      <div className="timeline-container right">
        <ImageListItem
          ...
          vector={{
            src: "https://cdn.ms-mf.org/images/Incubation/list 1.png",
            alt: "Innovation",
          }}
        />
      </div>
      <div className="timeline-container left">
        <ImageListItem
          ...
          vector={{
            src: "https://cdn.ms-mf.org/images/Incubation/hand-shake 1.png",
            alt: "Innovation",
          }}
        />
      </div>
      <div className="timeline-container right">
        <ImageListItem
          ...
          vector={{
            src: "https://cdn.ms-mf.org/images/Incubation/group 1.png",
            alt: "Innovation",
          }}
        />
      </div>
