...
const IncubateeCard = (props: IncubateeCardProps) => {
  ...
  return (
    <div className="w-full h-min bg-white my-8 px-6 py-10 rounded shadow-md flex items-center justify-between divide-x divide-[#8A8A8A]">
      <div className="w-4/12 h-52 p-4 flex justify-center items-center">
        <img src={logo} alt={`${incubateeName} Logo`} className="w-9/12  object-scale-down" />
      </div>
