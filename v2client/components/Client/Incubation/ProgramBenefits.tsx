      ...
      <SectionContent>
        <div className="grid gap-14 grid-cols-2">
          <ImageListItem
            ...
            vector={{
              src: "/assets/images/Incubation/research (3).png",
              alt: "research",
            }}
          />
          <ImageListItem
            ...
            vector={{
              src: "/assets/images/Incubation/autism.png",
              alt: "research",
            }}
          />
          <ImageListItem
            ...
            vector={{
              src: "/assets/images/Incubation/prototyping.png",
              alt: "research",
            }}
          />
          <ImageListItem
            ...
            vector={{
              src: "/assets/images/Incubation/validation.png",
              alt: "research",
            }}
          />
          <ImageListItem
            ...
            vector={{
              src: "/assets/images/Incubation/stethoscope (2).png",
              alt: "research",
            }}
          />
          <ImageListItem
            ...
            vector={{
              src: "/assets/images/Incubation/genomics.png",
              alt: "research",
            }}
          />
        </div>
