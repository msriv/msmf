        ...
        <ContentCard>
          <div className="w-full flex justify-between">
            <div className="w-6/12 px-4">
              ...
              <p className="">
                In treating a disease, a good diagnosis is the battle half won.
                Thus ADRC, Advanced Diagnostic Research Center, has been
                ...
                multidisciplinary clinical research to bring out the synergy of
                the treating physicians, the pathologists and the scientists.{" "}
              </p>
