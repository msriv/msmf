...
const FacilitiesList: Array<{
    ...
    aboutFacility: (
      <>
        <p className="m-0 mb-2">
          <b>Machine Learning Computers: </b> State of the art machine
          architecture with 128 GB RAM, Intel Xeon processor equipped with
  ...
  },
  {
    provider: "BioNEST",
    facilityName: "Artificial Intelligence and Machine Learning Lab",
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Azure.png",
    aboutFacility: (
      <>
        <p className="m-0 mb-2">
          <b>Microsoft Azure Cloud Services: </b> Microsoft Azure cloud service
          subscription license is available for cloud-based machine learning,
          computing and other storage requirements.
        </p>
      </>
    ),
  },

  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Method_Printer.jpg",
    aboutFacility: (
      <>
        <p>
  ...
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Artec 3d scanner.jpg",
    aboutFacility: (
      <>
        <p>
  ...
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Solidworks.png",
    aboutFacility: (
      <p>
  ...
  {
    facilityName: "Mechanical Design Fabrication Lab",
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/3AXIS_CNC_Machine.jpg",
    aboutFacility: (
      <p>
        <b>ACE 3-Axis CNC Machine:</b> The 3-axis computer controlled vertical
        milling machine can create custom parts in metals with highest
        precision.
      </p>
    ),
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Manual Lathe.jpeg",
    aboutFacility: (
      <p>
        The manual lathe machine can perform rotary milling, drilling and finish
        operations.
      </p>
    ),
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Manual Milling.jpeg",
    aboutFacility: (
      <p>
  ...
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Sintering machine.jpeg",
    aboutFacility: (
      <p>
        Sintering machine works along with the FDM based 3D printer to create
  ...
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Casting_Machine.jpeg",
    aboutFacility: (
      <p>
        The cast machine is used to create custom casts and moulds for making
        custom metal parts.
      </p>
    ),
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/TIG_Welding_2.jpeg",
    aboutFacility: (
      <p>
        The TIG welders can be used to weld steel, stainless steel, chromoly,
        aluminium, nickel alloys, magnesium, copper, brass, bronze, and even
        gold.
      </p>
    ),
  },
  {
    ...
    aboutFacility: (
      <p>
        <b>Machinex PCB milling machine: </b>3-Axis PCB milling machine to etch
        circuits on the copper clad sheet for creating fast and custom printed
        circuit boards.
      </p>
    ),
  },
  {
    ...
    aboutFacility: (
      <p>
        2-Axis Laser stencil cutting machine to cut stencils for components to
        be placed in the printed circuit boards.
      </p>
    ),
  },
  {
    ...
    aboutFacility: (
      <p>
        ...
        leads to multiple prototype boards with the stencils printed from the
  ...
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Neoden_3V_pick.jpg",
    aboutFacility: (
      <p>
        Computerized vision-based component placement to avoid manual error and
        reduce component placing time on the printed circuit board.
      </p>
    ),
  },
  {
    facilityName: "Reflow oven: ",
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Reflow oven.jpg",
    aboutFacility: (
      <p>
  ...
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Soldering Station.jpg",
    aboutFacility:
  ...
  },
  {
    ...
    thumbnail: "https://cdn.ms-mf.org/images/Incubation/Debugging Station.jpg",
    aboutFacility:
