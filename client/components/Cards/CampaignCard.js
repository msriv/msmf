  ...
  return (
    <Card className={classes.root}>
      ...
      <CardContent>
        ...
        <p className="mt-10 font-inter-regular text-base text-shark-400">
          <span className="text-lg font-inter-bold">{achieved}</span> out of{" "}
          <span className="font-inter-bold">{goal}</span>
        </p>
        <CardLinearProgress
          variant="determinate"
          value={parseInt((achieved / goal) * 100)}
        />
